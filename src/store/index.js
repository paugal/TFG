...
export default createStore({
  state: {
    ...
    msg:[
      ...
      {id: 131, text: 'Muchas gracias por todo!!!', sender: 2, to: 2, question: null, shown: false, visto: false},
    ...
    path:[
      ...
      {id: 47, question: 26, to: 8, text: 'Gracias', activator: [159, 126, 127, 128, 129, 130], enableOption: [0], karma: 0, shown: false},
