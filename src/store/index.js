...
export default createStore({
  state: {
    ...
    msg:[
      ...
      {id: 3, text: 'Óscar me ha abierto y me ha dicho que ha pasado algo', sender: 1, to: 2, question: null, shown: false, visto: true},
      ...
      {id: 1007, text: 'ya ves, mañana en clase te cuento', sender: 3, to: 3, question: null, shown: false, visto: false},
      ...
      {id: 70, text: 'O si le ha hecho algo', sender: 4, to: 4, question: 12, shown: false, visto: false},
      ...
      {id: 172, text: 'Podemos quedar para ir a playa esta tarde ', sender: 4, to: 4, question: null, shown: false, visto: false},
      {id: 73, text: 'Buena idea, eso le ayudará a despejarse 😊', sender: 4, to: 4, question: null, shown: false, visto: false},
      {id: 74, text: 'tal vez nos cuenta que ha pasado', sender: 4, to: 4, question: null, shown: false, visto: false},
      {id: 75, text: 'Ahora escribo en el grupo de amigos', sender: 4, to: 4, question: 13, shown: false, visto: false},
      {id: 375, text: 'Genial!', sender: 1, to: 4, question: null, shown: false, visto: true},
      {id: 76, text: 'Marta: Hola chicos!!🙋🏻‍♀️', sender: 5, to: 5, question: null, shown: false, visto: false},
      ...
      {id: 92, text: 'Puff no sé que deberíamos hacer...😓', sender: 4, to: 4, question: null, shown: false, visto: false},
      {id: 93, text: 'Hola, ha pasado algo grave', sender: 6, to: 6, question: null, shown: false, visto: false},
      {id: 94, text: 'Esta mañana Óscar ha creado un chat de grupo con sus amigos', sender: 6, to: 6, question: null, shown: false, visto: false},
      ...
      {id: 98, text: 'No me quiero meter, se van a meter conmigo sino', sender: 1, to: 6, question: 18, shown: false, visto: true},
      {id: 99, text: 'En serio???? Después de lo que te he encontrado', sender: 6, to: 6, question: null, shown: false, visto: false},
      ...
      {id: 120, text: 'Silvia: sii, para cualquier cosa que necesites ❤️​❤️​❤️​', sender: 5, to: 5, question: null, shown: false, visto: false},
      ...
      {id: 126, text: 'Holaa!', sender: 2, to: 2, question: null, shown: false, visto: false},
      {id: 127, text: 'Quería darte las gracias por todo', sender: 2, to: 2, question: null, shown: false, visto: false},
      {id: 128, text: 'Han sido unos dias dificiles y no se que habria hecho in vosotros', sender: 2, to: 2, question: null, shown: false, visto: false},
      {id: 129, text: 'Marta me ha contado lo  que has ayudado y estoy muy contento', sender: 2, to: 2, question: null, shown: false, visto: false},
      {id: 130, text: 'de tener amigos como tu', sender: 2, to: 2, question: null, shown: false, visto: false},
      {id: 131, text: 'Muchas gracias por todo!!!', sender: 2, to: 2, question: 21, shown: false, visto: false},
      {id: 132, text: '----', sender: 2, to: 2, question: 21, shown: false, visto: false},
      ...
      {id: 136, text: '------', sender: 2, to: 2, question: null, shown: false, visto: false},
    ...
    path:[
      ...
      {id: 9, question: 4, to: 2, text: 'Preguntar por Oscar', activator: [3, 11, 12], enableOption: [0], karma: 0, shown: false},
      ...
      {id: 24, question: 11, to: 4, text: 'Quitar importancia', activator: [66, 67, 68, 69, 70, 172, 74, 75], enableOption: [0], karma: -1, shown: false},
      {id: 25, question: 11, to: 4, text: 'Quedar por la tarde', activator: [72, 73, 74, 75], enableOption: [0], karma: 1, shown: false},
      {id: 26, question: 11, to: 4, text: 'Hacer lo mismo a Oscar', activator: [62, 362, 63, 64, 172, 74, 75], enableOption: [27], karma: -1, shown: false},
      ...
      {id: 32, question: 16, to: 4, text: 'Creo que no', activator: [90, 92, 93, 94, 95, 96, 97], enableOption: [0], karma: 0, shown: false},
      ...
      {id: 35, question: 17, to: 6, text: 'Hablar seriamente con Marcos', activator: [101, 102, 103], enableOption: [0], karma: 1, shown: false},
      ...
      {id: 47, question: 26, to: 8, text: 'Gracias', activator: [159, 126, 127, 128, 129, 130, 131], enableOption: [0], karma: 0, shown: false},
