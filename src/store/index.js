...
export default createStore({
  state: {
    ...
    msg:[
      ...
      {id: 1001, text: 'Pero de qué vas Oscar?', sender: 1, to: 3, question: null, shown: false, visto: true},
      {id: 1002, text: 'Marcos es mi amigo, no pienso dejar que vayas insultando', sender: 1, to: 3, question: null, shown: false, visto: true},
      {id: 1003, text: 'Lo que tu digas, pringado', sender: 3, to: 3, question: null, shown: false, visto: false},
      {id: 1004, text: 'Oscar te ha bloqueado', sender: 3, to: 3, question: null, shown: false, visto: false},
      {id: 1005, text: 'Enserio? bua ya me contaras que ha hecho ese pringado', sender: 1, to: 3, question: null, shown: false, visto: true},
      {id: 1006, text: 'Nunca me ha caido bien', sender: 1, to: 3, question: null, shown: false, visto: true},
      ...
      {id: 18, text: 'Que raro que se haya saltado basquet', sender: 1, to: 4, question: 9, shown: false, visto: true},
      ...
      {id: 24, text: 'Lo ha empezado a insultar y no quería discutir', sender: 1, to: 4, question: null, shown: false, visto: true},
      ...
      {id: 32, text: 'Espero que así le quede claro  a Oscar que hacer lo que hace es horrible', sender: 4, to: 4, question: null, shown: false, visto: false},
      ...
      {id: 40, text: 'Me estas mintiendo?', sender: 4, to: 4, question: null, shown: false, visto: false},
      ...
      {id: 114, text: 'Es buena idea pero creo que primero tenemos que aclararlo con Marcos', sender: 4, to: 4, question: null, shown: false, visto: false},
      {id: 115, text: 'Mala opción', sender: 1, to: 4, question: null, shown: false, visto: true},
      ...
      path:[
        ...
        {id: 16, question: 62, to: 4, text: '(mentir) Insulte a Marcos (verdad) defender', activator: [40, 41, 42, 43, 44, 45], enableOption: [21], karma: -1, shown: false},
        {id: 17, question: 62, to: 4, text: '(mentir) Insulte a Marcos (verdad) neutro', activator: [40, 41, 42, 43, 49], enableOption: [21], karma: -1, shown: false},
        ...
        {id: 39, question: 19, to: 4, text: 'Mala opción', activator: [115, 116, 1162, 118, 119, 120, 121], enableOption: [0], karma: -1, shown: false},
        {id: 40, question: 20, to: 5, text: 'Animar a Marcos', activator: [122, 123, 124, 125, 126, 127, 128, 129, 130, 131, 132], enableOption: [0], karma: 1, shown: false},
        {id: 41, question: 20, to: 5, text: 'No decir nada', activator: [123, 124, 125, 126, 127, 128, 129, 130, 131, 132], enableOption: [0], karma: 0, shown: false},
